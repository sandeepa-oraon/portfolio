		...
		<>
			<div className="home-container">
				...
				<div className="connect-flex">
					<a href="https://github.com/sandeepa-oraon/" target="_blank" className="connect social">
						<span className="">
					...
					<a href="https://www.linkedin.com/in/sandeepa-oraon/" className="connect social">	
						<span className="">
					...
					<a href="" className="connect social">
						<span className="">
